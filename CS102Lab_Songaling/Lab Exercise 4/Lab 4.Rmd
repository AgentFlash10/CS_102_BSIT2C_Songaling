...
url <- 'https://arxiv.org/search/?query=Sports&searchtype=all&abstracts=show&order=-announced_date_first&size=50'
...
# Export the result
save(papers, file = "Arxiv_Sports.RData")
write.csv(papers, file = "Arxiv papers on Sports.csv")
```